...
export const taichungTaxiServiceQualitySurvey: QuestionnaireTemplate = {
  id: "taichung-taxi-service-quality-survey",
  title: "臺中市計程車服務品質評鑑調查",
  description:
    "本評鑑調查目的在了解您對臺中市計程車服務品質的感受及意見，做為後續服務改善參考，謝謝！",
  banner: "/banner-video/tai-chung.mp4",
  version: "1.0.0",
  organize: "臺中市政府",
  isRepeatable: true,
